...
module.exports = {
  resolve: {
    ...
    extsions: ["", ".webpack.js", ".web.js", ".ts", ".tsx", ".js"]
  },
  mode: "development", // this will trigger some webpack default stuffs for dev
  entry: path.resolve(__dirname, "../src/index.ts"), // if not set, default path to './src/index.js'. Accepts an object with multiple key-value pairs, with key as your custom bundle filename(substituting the [name]), and value as the corresponding file path
  output: {
